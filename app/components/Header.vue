<template>
  <header class="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
    ...
    <div
      class="max-w-screen-xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16"
    >
      <!-- Left: Logo -->
      ...
      >
        <div class="w-72 bg-white h-full shadow-xl p-6 overflow-y-auto">
          ...
          <div class="mt-8 space-y-6">
            ...
            <a class="block text-gray-700 text-[15px] font-medium border-b pb-3"
              >Offers</a
            >
            <a class="block text-gray-700 text-[15px] font-medium border-b pb-3"
              >Women</a
            ...
            <button
              class="w-full bg-black text-white py-3 rounded-full font-medium mt-6 hover:bg-gray-900 transition"
            >
              Get Started
            </button>
          </div>
    ...
    <transition name="slide">
      <div
        v-if="cartOpen"
        class="fixed inset-0 z-50 bg-transparent bg-opacity-40 flex justify-end"
        @click.self="cartOpen = false"
      >
        <!-- Cart Slider -->
        <div
          class="flex h-full w-80 md:w-96 flex-col overflow-y-auto bg-white rounded-l-xl shadow-2xl"
        >
          <!-- Cart Header -->
          <div
          ...
          <div class="flex-1 overflow-y-auto px-6 py-4 space-y-4">
            ...
            <ul role="list" class="space-y-4">
              ...
              >
                <div
                  class="w-16 h-16 flex-shrink-0 overflow-hidden rounded-lg bg-gray-50 border border-gray-200"
                >
                  <img
                    :src="
                      item.imageUrl ||
